const post2 = {
  ...
  content: `
    ...
    <p>Maya's story continues with her journey of using the Secundus Dermis for protection during her athletic activities, the gradual wear and staining that came from this use, and how she learned to see these changes as badges of honor rather than damage.</p>
    ...
    <h2>The Innovation: Understanding the Design Intent</h2>
    ...
    <p>This feature represents our broader philosophy of thoughtful, compassionate design. We believe that premium clothing should adapt to your life's realities, not force you to adapt to its limitations.</p>
    
    <p>This is an example of how we're reimagining what foundation wear can be—not just comfortable and luxurious, but truly functional for the complex realities of women's lives, including the challenges that are rarely discussed but deeply felt.</p>
  `,
