      ...
      <div className="container">
        <div className="contact-header">
          ...
          <div className="contact-notice">
            <strong>Note:</strong> Secundus Dermis is not a real brand or clothing retailer.
            This site is a demonstration playground for AI-powered customer support agents —
            simulating how a fashion boutique chatbot could handle product discovery,
            styling advice, and service inquiries.
          </div>
        </div>
